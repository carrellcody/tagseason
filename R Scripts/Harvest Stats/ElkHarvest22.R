...
## Load spreadsheets
EHarvestRaw <- as.data.table(read_excel("Raw data/Harvest_and_public/Harvest starting data/2022 Statewide Elk Harvest_Raw.xlsx", sheet="Normal"))
EHarvestSC <- as.data.table(read_excel("Raw data/Harvest_and_public/Harvest starting data/2022 Statewide Elk Harvest_Raw.xlsx", sheet="SC"))
...
cat_cpw_map_elk<-c('2022 Elk Harvest, Hunters and Recreation Days for All Manners of Take',
                   '2022 Elk Harvest, Hunters and Recreation Days for All Rifle Seasons',
                   '2022 Elk Harvest, Hunters and Recreation Days for All Ranching for Wildlife Seasons',
                   '2022 Elk Harvest, Hunters and Recreation Days for Early High Country Seasons',
                   '2022 Elk Harvest, Hunters and Recreation Days for Late Seasons (Includes PLOs)',
                   '2022 Elk Harvest, Hunters and Recreation Days for Private Land Only Seasons',
                   '2022 Elk Harvest, Hunters and Recreation Days for First Rifle Seasons',
                   '2022 Elk Harvest, Hunters and Recreation Days for Second Rifle Seasons',
                   '2022 Elk Harvest, Hunters and Recreation Days for Third Rifle Seasons',
                   '2022 Elk Harvest, Hunters and Recreation Days for Fourth Rifle Seasons',
                   '2022 Elk Harvest, Hunters and Percent Success for All Rifle Seasons',
                   '2022 Elk Harvest, Hunters and Percent Success for First Rifle Seasons',
                   '2022 Elk Harvest, Hunters and Percent Success for Second Rifle Seasons                                                47',
                   '2022 Elk Harvest, Hunters and Percent Success for Third Rifle Seasons                                                   51',
                   '2022 Elk Harvest, Hunters and Percent Success for Fourth Rifle Seasons                                                 55',
                   '2022 Elk Harvest, Hunters and Recreation Days for All Archery Seasons                                                  59',
                   '2022 Elk Harvest, Hunters and Recreation Days for All Muzzleloader Seasons                                         64',
                   '2022 Elk Harvest, Hunters and Percent Success for All Muzzleloader Seasons                                         68',
                   '2022 Elk Harvest, Hunters and Recreation Days for 1st Season Limited Antlered Seasons                     72',
                   '2022 Elk Harvest, Hunters and Recreation Days for 2nd Season Limited Antlered Seasons                     75',
                   '2022 Elk Harvest, Hunters and Recreation Days for 3rd Season Limited Antlered Seasons                     77',
                   '2022 Elk Harvest, Hunters and Recreation Days for 4th Season Limited Antlered Seasons                     79',
                   '2022 Elk Harvest, Hunters and Recreation Days for 1st Season Limited Antlerless Seasons                   82',
                   '2022 Elk Harvest, Hunters and Recreation Days for 2nd Season Limited Antlerless Seasons                  85',
                   '2022 Elk Harvest, Hunters and Recreation Days for 2nd Split Season Limited Antlerless Seasons         89',
                   '2022 Elk Harvest, Hunters and Recreation Days for 3rd Season Limited Antlerless Seasons                   90',
                   '2022 Elk Harvest, Hunters and Recreation Days for 3rd Split Season Limited Antlerless Seasons         94',
                   '2022 Elk Harvest, Hunters and Recreation Days for 4th Season Limited Antlerless Seasons                   95',
                   '2022 Elk Harvest, Hunters and Recreation Days for 4th Split Season Limited Antlerless Seasons         99',
                   '2022 Elk Harvest, Hunters and Recreation Days for 1st Season Limited Either-sex Seasons                 100',
                   '2022 Elk Harvest, Hunters and Recreation Days for 2nd Season Limited Either-sex Seasons                101',
                   '2022 Elk Harvest, Hunters and Recreation Days for 3rd Season Limited Either-sex Seasons                102',
                   '2022 Elk Harvest, Hunters and Recreation Days for 4th Season Limited Either-sex Seasons                103',
                   '2022 Elk Harvest, Hunters and Recreation Days for Early PLO Seasons Only                                          104',
                   '2022 Elk Harvest, Hunters and Recreation Days for Late PLO Seasons Only                                           107',
                   '2022 Elk Harvest, Hunters and Recreation Days for All Late Seasons (Does not include PLOs)           108',
                   '2022 Elk Harvest, Hunters and Percent Success for All Late Seasons (Does not include PLOs)           110',
                   '2022 Elk Harvest, Hunters and Recreation Days for All Bosque del Oso Seasons',
                   '2022 Elk Harvest, Hunters and Recreation Days for All Damage, AFA and Auction/Raffle Hunts',
                   'Dummy')
...
EHarvestFinal22<-rbind(EHarvestSC,EHarvestRaw, use.names=TRUE, fill=TRUE)


write_xlsx(EHarvestFinal22,'Raw data/Harvest_and_public/ElkHarvest22Final.xlsx')
