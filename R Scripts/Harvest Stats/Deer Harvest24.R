...
## Load spreadsheets
DHarvestRaw <- as.data.table(read_excel("Raw data/2024 Statewide Deer Harvest_Raw.xlsx", sheet="Normal"))
DHarvestSC <- as.data.table(read_excel("Raw data/2024 Statewide Deer Harvest_Raw.xlsx", sheet="SeasonChoice"))
...
#Reomve "Total" lines
DHarvestSC<-DHarvestSC[!grepl("Total",Unit)]
...
DHarvestFinal24<-rbind(DHarvestSC,DHarvestRaw, use.names=TRUE, fill=TRUE)


write_xlsx(DHarvestFinal24,'Raw data/Harvest_and_public/DeerHarvest24Final.xlsx')
